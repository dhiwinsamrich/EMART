...
const InvoiceDetailPage = ({ item }) => {
  ...
  const initialValues = {
    productName: location.state.record.item.productName,
    customerName: '',
...
//   }
  ...
  return (
    ...
    <Grid item xs={12} style={{ margin: "20px", height: '800px' }}>
      <div style={{backgroundColor: '#DDD0C8', borderRadius: '25px', boxShadow: '3px 3px 3px 4px #323232', height: '500px'}}>
        <div style={{ textAlign: "center", marginBottom: "10px",marginTop:'100px',
        fontSize: 30,textShadow: '2px 2px 2px #323232' }}>
        {
